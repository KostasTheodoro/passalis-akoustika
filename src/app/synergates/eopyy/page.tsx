    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 text-center">
        ...
        <div className="text-xl text-gray-700 mb-24 whitespace-pre-line leading-relaxed">
          Ο ΕΟΠΥΥ έχει αλλάξει τον τρόπο αποζημίωσης ετσι ώστε ο ασφαλισμένος να
          καταβάλλει μόνο την συμμετοχή του και όχι ολόκληρο το ποσό.
          {"\n\n"}
          Καλύπτει το ποσό των 450€ για άμεσα και έμμεσα ασφαλισμένους και βοηθά
          να έχουν πρόσβαση στις καλύτερες λύσεις που καλύπτουν τις ακουστικές
          τους ανάγκες, ενώ για παιδιά έως 16 ετών, ο ΕΟΠΥΥ καλύπτει το ποσό των
          540€ ανά ακουστικό ανά 4 έτη.
          {"\n\n"}Ο ασφαλιζόμενος προσκομίζοντας τα απαραίτητα δικαιολογητικά σε
          εμάς, πλέον πληρώνει μόνο την συμμετοχή του αποφεύγοντας την
